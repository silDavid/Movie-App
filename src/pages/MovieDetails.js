...
const MovieDetails = ({ match }) => {
    ...
    return (
        <div className="movie-details container p-5">
            <div className="row justify-content-md-center align-items-center no-gutters">
                <div className="col-md-4">
                    <img src={movieDetails.Poster} className="wallpaper card-img"></img>
                </div>
                <div className="col-md-8">
                    <div className="card-body">
                        <h1 className="display-5 p-3">{movieDetails.Title}</h1>
                        <ul className="list-group">
                            ...
                            <li className="list-group-item"><strong>Writers: </strong>{movieDetails.Writer}</li>
